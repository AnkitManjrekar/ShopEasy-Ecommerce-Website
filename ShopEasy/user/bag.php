...
<div class="container-fluid">
  <div class="col-md-12"> 
  <div class="row">
    <h1 class="text-center text-primary">BAGS</h1>
      <?php 
        include 'config.php';
        ...
        while($row = mysqli_fetch_array($record)){
          if($row['pCategory'] === 'Bag'){
            ...
            <div class='col-md-6 col-lg-4 m-auto'> 
              <div class=' card p-3 text-center border rounded border-2 border-danger mb-4 m-auto' style='width: 23rem;'>
                  <img src='../admin/product/$row[pImage]' class='m-auto card-img-top border rounded border-1 border-muted' alt='...' style='height: 210px; width: 250px;'>
                  <div class='card-body'>
